...
class ScheduleDatePickerEndDt extends StatefulWidget {
  final Widget back_page ;
  final String title;

  const ScheduleDatePickerEndDt({
  ...
  @override
  State<ScheduleDatePickerEndDt> createState() => _ScheduleDatePickerEndDt();
}

class _ScheduleDatePickerEndDt extends State<ScheduleDatePickerEndDt> {
            ...
            Container(
              ...
              child: CupertinoTheme(
                ...
                child: CupertinoDatePicker(
                  initialDateTime: scheduleController.selectedEndDt.value,
                  maximumYear: 2300,
                  minimumYear: 2000,
