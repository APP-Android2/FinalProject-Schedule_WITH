...
class BottomSheetDetailStartTime extends StatelessWidget {
          ...
          child: Padding(
              ...
              child: Row(
                  ...
                  children: [
                    ...
                    Obx(() => 
                        Text(
                        scheduleController.selectedStartTm.value == null 
                            ? '선택' 
                            : formatter.format(scheduleController.selectedStartTm.value!),
